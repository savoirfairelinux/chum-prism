                ...
                (<div className={layoutStyles.modalIndex}>
                    <div className={layoutStyles.modalContent}>
                        <div className={layoutStyles.modalContentCloseWrapper}>
                            <div className={layoutStyles.modalContentClose} onClick={() => setOpen(false)} >
                                <img className={layoutStyles.modalContentCloseIcon} src={cross} alt="close" />
                            </div>
                        </div>
                        <div>
                            ...
                            <div className={layoutStyles.modalContentDivider} onClick={() => setOpen(false)}>
